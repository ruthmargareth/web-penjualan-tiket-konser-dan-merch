        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    ...
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="./assets/img/merch/<?php echo $row["img_merch"]; ?>" alt="Card image cap" id="product-detail">
                    </div>
                </div>
                <!-- col end -->
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2"><?= $row['nama_merch']; ?></h1>
                            <!-- <h1 class="h2">(General Sales)</h1> -->
                            <p class="h3 py-2">IDR <?= $row['harga_merch']; ?></p></p>
                            <!-- <p class="py-2">
                                <span class="list-inline-item text-dark">Saturday 04.02.2023 6:30PM</span>
                            </p> -->
                            <ul class="list-inline">
                                <li class="list-inline-item">
                                    <h6 color="red"><?php echo $stock?> - <?php echo $row['stock_merch'] ?></h6>
                                </li>
                            </ul>

                            <h6>Description:</h6>
                            <p><?= $row['deskripsi_merch']; ?></p>
                            <ul class="list-inline">
                                <li class="list-inline-item">
                            ...
                            <form action="" method="GET">
                                ...
                                <div class="row pb-3">
                                    <div class="col d-grid">
                                        <form action="POST">
                                            <input type="hidden" value="<?php echo $row['id_merch']; ?>">
                                            <a href="pembayaran.php?id= <?= $row['id_merch']; ?>" class="btn btn-success btn-lg" name="submit" value="buy">Buy</a>
                                        </form>
                                    </div>
                                    <div class="col d-grid">
