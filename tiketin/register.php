 ...
 <!-- Start Brands -->
    ...
    <div class="container pb-5">
        <div class="row justify-content-md-center pb-5">
          <div class="col-md-6 pb-3 pt-3 px-6 bg-light rounded">
            <form class="py-3" method="POST" action="./action/registerAct.php">
                <div class="form-group pb-3">
                  <label for="email">Email address</label>
                  <input type="email" class="form-control em" id="email" name="email" aria-describedby="Email" placeholder="E-mail">
                </div>
                <div class="form-group pb-3">
                  <label for="password">Password</label>
                  <input type="password" class="form-control pw" id="password" name="password" placeholder="Password">
                </div>
                <button type="submit" class="btn btn-success form-control">Daftar</button>
                <div class="form-group offset-md-7 pt-3">
                    
                    <label for="exampleInputPassword1">Sudah punya akun? Log in <a href="login.php">di sini</a></label>
                  </div>
              </form>
          </div>
